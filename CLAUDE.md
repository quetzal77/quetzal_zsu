...
- `"wide": True` — плашка розкладається фіксованим грідом (`"grid_cols"`, за замовчуванням 4
  колонки; 5 — у Оперативних командувань і Армійських корпусів, бо в них 3 додаткові поля) і займає
  весь рядок (для довідників із кількома додатковими полями, напр. Деталі родів військ, Оперативні
  командування, Армійські корпуси); без цього прапорця — звичайний flex-рядок на половину ширини
  сторінки (напр. Роди військ, Локації).
